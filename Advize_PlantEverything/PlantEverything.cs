...
namespace Advize_PlantEverything
{
    ...
    public partial class PlantEverything : BaseUnityPlugin
    {
        ...
        public static void InitLocalization()
        {
            ...
            //if (config.EnableExtraResources && deserializedExtraResources.Count > 0)
            //{
            //    foreach (PieceDB pdb in pieceRefs)
            //    {
            //        if (!pdb.extraResource) continue;

            //        Localization.instance.AddWord($"pe{pdb.Name}Name", pdb.pieceName);
            //        Localization.instance.AddWord($"pe{pdb.Name}Description", pdb.pieceDescription);
            //    }
            //}
