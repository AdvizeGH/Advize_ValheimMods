...
namespace Advize_PlantEasily.Configuration
{
    class ModConfig
    {
        ...
        internal ModConfig(ConfigFile configFile)
        {
            ...
            standardizeGridSpacing = Config.Bind("General", "StandardizeGridSpacing", true, "When set to true, spacing between each type of plant will be normalized to an equal distance. Setting this to false will allow for tighter grids, but with varying spacing used between diverse plants. ");
